...
var ReactReader = function (_Component2) {
  ...
  function ReactReader(props) {
    ...
    _this2.next = function () {
      _this2.props.nextPage(_this2.refs.reader.nextPage);
    };

    _this2.prev = function () {
      _this2.props.prevPage(_this2.refs.reader.prevPage);
    };
...
ReactReader.propTypes = {
  ...
  prevPage: _propTypes2.default.func,
  nextPage: _propTypes2.default.func,
  blockOnEndOfChapter: _propTypes2.default.func
};
